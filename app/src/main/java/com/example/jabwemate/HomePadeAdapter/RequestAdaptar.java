...
public class RequestAdaptar extends FirestoreRecyclerAdapter<Dog, RequestAdaptar.RequestViewHolder> {

    private String IDD;

    public RequestAdaptar(@NonNull FirestoreRecyclerOptions<Dog> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull final RequestViewHolder holder, final int position, @NonNull final Dog model) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent i = new Intent(view.getContext(), RequestRejectAccept.class);
                i.putExtra("REF", g);
                i.putExtra("ID", IDD);
